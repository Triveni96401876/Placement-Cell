            ...
            <body>
                    ...
                    <div class="cockpit-grid">
                        ...
                        <div class="main-cockpit">
                            ...
                            <div class="feature-card">
                                ...
                                <h3>Session Info</h3>
                                <p style="font-size: 0.8rem; color: #666; margin-bottom: 15px;">Securely logged in from
                            ...
                            <div class="feature-card" style="grid-column: span 2;">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <div>
                                        ...
                                        <p style="color: #666; font-size: 0.9rem;">Your personalized placement resume is
                                            ready. Keep it updated for better sorting.</p>
                                    </div>
                                    <div style="display: flex; gap: 10px;">
                                        <a href="javascript:void(0)" onclick="openResumeUpdateModal()" class="nav-item"
                        ...
                        <div class="activity-panel">
                            ...
                            <div
                                ...
                                <p style="font-size: 0.8rem;">Did you know? Completing your profile increases shortlist
                                    chances by 40%.</p>
                            </div>
                        </div>
                ...
                <div id="lockerContentModal" class="modal"
                    ...
                    <div class="modal-content"
                        ...
                        <div
                            ...
                            <h2 style="color:var(--primary); margin:0;"><i class="fas fa-shield-alt"></i> Digi Locker
                            </h2>
                        ...
                        <div
                            ...
                            <div style="background:#f8f9fa; padding:20px; border-radius:15px; text-align:center;">
                                ...
                                <% if (student.getSslcCardPath() !=null) { %>
                                    <a href="uploads/<%= student.getSslcCardPath() %>" target="_blank"
                                        style="color:var(--primary); font-weight:600;">View Document</a>
                                    <% } else { %>
                            ...
                            <div style="background:#f8f9fa; padding:20px; border-radius:15px; text-align:center;">
                                ...
                                <% if (student.getDiplomaCardPath() !=null) { %>
                                    <a href="uploads/<%= student.getDiplomaCardPath() %>" target="_blank"
                                        style="color:var(--primary); font-weight:600;">View Document</a>
                                    <% } else { %>
                                        <p style="color:#7f8fa6; font-size:0.8rem;">Not Uploaded</p>
                                        <% } %>
                            ...
                            <div style="background:#f8f9fa; padding:20px; border-radius:15px; text-align:center;">
                                <i class="fas fa-id-card fa-3x" style="color:var(--secondary); margin-bottom:10px;"></i>
                                <h4>Current Resume</h4>
                                <% if (student.getResumePath() !=null) { %>
                                    <a href="uploads/<%= student.getResumePath() %>" target="_blank"
                                        style="color:var(--primary); font-weight:600;">View Recently Updated</a>
                                    <% if (student.getResumeDescription() !=null) { %>
                                        <p style="font-size: 0.75rem; color: #666; margin-top:5px;">"<%=
                                                student.getResumeDescription() %>"</p>
                                        <% } %>
                                            <% } else { %>
                                                <a href="ResumeServlet" target="_blank"
                ...
                <script>
                    ...
                    function verifyLockerAccess() {
                        ...
                        if (pass === '1234' || pass === 'password') {
                            closeLockerAuth();
                            document.getElementById('lockerContentModal').style.display = 'block';
                        } else {
                            showToast('Invalid Password! Demo use: "1234"', '#e74c3c');
                        }
                    }
