...
public class StudentDAO {
    ...
    public boolean updateDocumentPath(Long id, String column, String path) throws SQLException {
        String sql = "UPDATE resumes SET " + column + " = ? WHERE student_id = ?";
        try (Connection conn = DBConnection.getConnection();
    ...
    public boolean updateDocumentStatus(Long id, String status) throws SQLException {
        String sql = "UPDATE academic_details SET approval_status = ? WHERE student_id = ?";
        try (Connection conn = DBConnection.getConnection();
                PreparedStatement ps = conn.prepareStatement(sql)) {
