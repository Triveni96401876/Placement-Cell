<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>HOD Login | SGP Placement Cell</title>
    ...
    <body>
        ...
        <div class="login-card">
            <div class="logo-section">
                ...
                <h1 class="admin-page-title">HOD Login</h1>
            </div>

            <div class="admin-note">
                <i class="fas fa-university"></i>
                HOD Portal - Department Administration
            </div>
            ...
            <% String error=request.getParameter("error"); if (error !=null) { %>
                <div class="error-message">
                    ...
                    <% if ("invalid_credentials".equals(error)) { %>
                        ...
                        <% } else if ("invalid_hod_role".equals(error)) { %>
                            Access Denied: HOD role required
                            <% } else { %>
                    ...
                    <form action="LoginServlet" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="email" placeholder="Enter HOD ID" required autofocus>
                            </div>
                        </div>
