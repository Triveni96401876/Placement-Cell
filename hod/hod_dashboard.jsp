        ...
        <%@ page import="com.placementcell.model.Student" %>
            <%@ page import="com.placementcell.model.User" %>
                <% List<Student> students = (List<Student>) request.getAttribute("studentList");
                        ...
                        if (u == null || !"HOD".equals(u.getRole())) {
                        ...
                        String mtClass = branchLow.contains("metallurgy") ? "active" : "";
                        ...
                        <body>
                            <aside>
                                ...
                                <nav>
                                    ...
                                    <div class="sidebar-label-btn" onclick="toggleBranches()">
                                        <span class="sidebar-label-text">Select Branches</span>
                                        <i class="fas fa-chevron-down" id="chevronIcon"></i>
                                    </div>
                                    <div class="branch-filter-list" id="branchList">
                                        <a href="HODDashboardServlet?branch=Computer%20Science"
                                            class="branch-item <%= cseClass %>"><i class="fas fa-laptop-code"></i>
                                            Computer Science</a>
                                        <a href="HODDashboardServlet?branch=Civil" class="branch-item <%= ceClass %>"><i
                                                class="fas fa-trowel-bricks"></i> Civil</a>
                                        <a href="HODDashboardServlet?branch=Mechanical"
                                            class="branch-item <%= meClass %>"><i class="fas fa-gears"></i>
                                            Mechanical</a>
                                        <a href="HODDashboardServlet?branch=Metallurgy"
                                            class="branch-item <%= mtClass %>"><i class="fas fa-microchip"></i>
                                            Metallurgy</a>
                                        <a href="HODDashboardServlet?branch=Electrical%20%26%20Electronics"
                                            class="branch-item <%= eeeClass %>"><i class="fas fa-bolt"></i> Electrical &
                                            Electronics</a>
                                        <a href="HODDashboardServlet?branch=Information%20Technology"
                                            class="branch-item <%= itClass %>"><i class="fas fa-network-wired"></i>
                                            Information Technology</a>
                                    </div>
                                    <a href="javascript:void(0)" onclick="checkCirculars(true)" class="nav-link"
                                        style="margin-top: 24px;"><i class="fas fa-bullhorn"></i> View Circulars</a>
                                </nav>
                            ...
                            <main>
                                <div class="header-section">
                                    ...
                                    <p>
                                        <% if (currentBranch !=null) { %>
                                            ...
                                            <% } else { %>
                                                Welcome back, HOD <%= userName %>!
                                                    <% } %>
                                    </p>
                                </div>
                                <div class="stats-grid">
                                    <div class="stat-card">
                                        <div class="stat-icon icon-blue"><i class="fas fa-users-viewfinder"></i></div>
                                        <div class="stat-info">
                                            <h3>
                                                <%= totalReg %>
                                            </h3>
                                    ...
                                    <div class="stat-card">
                                        <div class="stat-icon icon-yellow"><i class="fas fa-star-half-stroke"></i></div>
                                        <div class="stat-info">
                                            <h3>
                                                <%= avgCgpa %>
                                            </h3>
                                ...
                                <div class="content-card">
                                    <div class="card-header">
                                        <h2><i class="fas fa-list-ul"></i> Students List - <span id="branchLabel">
                                    ...
                                    <div class="table-container">
                                        <table id="studentsTable">
                                            ...
                                            <tbody id="studentsTableBody">
                                                <tr>
                                                    <td colspan="26"
                                                        style="text-align:center; padding:40px; color:#94a3b8;"><i
                                                            class="fas fa-circle-notch fa-spin"
                                                            style="font-size:1.5rem;"></i><br>Loading student data from
                                                        database...</td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <script>
                                    ...
                                    fetch(url)
                                        ...
                                        .then(data => {
                                            ...
                                            if (isFirstLoad) {
                                                ...
                                                const existingIds = new Set(existingRows.map(row => row.querySelector('td:nth-child(2)').textContent)); // Assuming Reg.No is unique and in 2nd column
                                            ...
                                            const now = new Date();
                                            document.getElementById('lastRefreshed').textContent = now.toLocaleTimeString();
                                        })
                                    ...
                                    fetch('GetCircularServlet')
                                        ...
                                        .then(data => {
                                            if (data.status === 'success') {
                                                ...
                                                document.getElementById('circularText').innerText = data.message || '';
                                                ...
                                                if (data.filePath && data.filePath.trim() !== '') {
                                                    ...
                                                    fileLink.querySelector('i').className = data.filePath.toLowerCase().endsWith('.pdf') ? 'fas fa-file-pdf' : 'fas fa-file-image';
                                                } else {
                                        ...
                                        .catch(err => { if (isManual) alert('Could not fetch circulars.'); });
                                }
                                ...
                                function toggleBranches() {
                                    ...
                                    localStorage.setItem('hodBranchesExpanded', !isVisible);
                                }
                                ...
                                window.addEventListener('DOMContentLoaded', () => {
                                    const expanded = localStorage.getItem('hodBranchesExpanded') === 'true';
                                    if (expanded) {
                                        document.getElementById('branchList').style.display = 'flex';
                                        document.getElementById('chevronIcon').style.transform = 'rotate(180deg)';
                                    }
                                    // Immediate first load from API
                                    fetchStudents();
                                    // Check circulars automatically
                                    setTimeout(() => checkCirculars(false), 1000);
                                    // Poll every 15 seconds for new students
